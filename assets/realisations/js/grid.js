...
;(function(window) {
    ...
    GridFx.prototype._openItem = function(ev, item) {
        ...
        this._setOriginal(gridImg.getAttribute('src'));
        ...
        if(descriptionEl) {
            ...
            if (href.includes('.png') || href.includes('.jpg') || href.includes('.jpeg'))link.innerHTML = "<i class=\"fas fa-image\"></i> Ouvir l'image";
            else if (href.includes('.gif')) link.innerHTML = "<i class=\"fas fa-images\"></i> Ouvrir l'image dynamique";
            else if (href.includes('.pdf')) link.innerHTML = "<i class=\"fas fa-file\"></i> Ouvrir le document";
            else if (href.includes('show3D') || href.includes('particles') ) link.innerHTML = "<i class=\"fas fa-cubes\"></i> Ouvrir l'objet 3D";
        ...
        /* Escape the details of realisations element */
        window.addEventListener('keydown', function(e){
            if(e.key === "Escape" /*&& e.keyCode === 27*/) self._closeItem();
        });
        ...
        onEndTransition(this.cloneImg, function() {
            ...
            imagesLoaded(self.originalImg, function() {
                ...
                onEndTransition(self.originalImg, function() {
                    // reset cloneImg
                    self.cloneImg.style.display = 'none'; // Bug clone fix
